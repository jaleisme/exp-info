        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header border-0 d-flex justify-content-between">
                  ...
                  <a href="{{ route('base-class.create') }}" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i><span class="ml-1">Add new data</span></a>
                </div>
                <!-- Light table -->
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-center">
                                <a class="btn btn-sm btn-white text-warning btn-icon-only d-flex justify-content-center align-items-center" href="{{ route('base-class.edit', $item->id) }}" tooltip="Edit">
                                  <i class="fas fa-pen"></i>
                                </a>
                                <form method="POST" action="{{ route('base-class.destroy', $item->id) }}">
                                    @csrf
                                    @method('DELETE')
