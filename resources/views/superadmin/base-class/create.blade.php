...
<div class="">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <form action="{{ route('base-class.store') }}" method="POST">
                    @csrf
                    <div class="card-header"><strong>New Class</strong></div>
                    <div class="card-body">
                        <div class="">
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="class_name" id="input-class-name" class="form-control" placeholder="E.g. Class A of 2021" required>
                                </div>
                                </div>
                                <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="leader" class="form-control" required>
                                        <option value="" selected disabled>Choose Class Leader</option>
